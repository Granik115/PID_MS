...
void MX_TIM1_Init(void)
{
  ...
  TIM_BDTRInitStruct.DeadTime = 148;
  ...
  uint32_t dead_time = __LL_TIM_CALC_DEADTIME(SystemCoreClock, LL_TIM_GetClockDivision(TIM1), dead_time_ns);
  LL_TIM_OC_SetDeadTime(TIM1, dead_time);
  ...
  LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOE);
    ...
    PE13     ------> TIM1_CH3
    */
  GPIO_InitStruct.Pin = PWM_M1_AN_Pin|PWM_M1_A_Pin|PWM_M1_BN_Pin|PWM_M1_B_Pin
                          |PWM_M1_CN_Pin|PWM_M1_C_Pin;
...
void MX_TIM2_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetActiveInput(TIM2, LL_TIM_CHANNEL_CH3, LL_TIM_ACTIVEINPUT_TRC);
...
void MX_TIM8_Init(void)
{
  ...
  uint32_t dead_time_ns = 1000;
  uint32_t dead_time = __LL_TIM_CALC_DEADTIME(SystemCoreClock, LL_TIM_GetClockDivision(TIM8), dead_time_ns);
  LL_TIM_OC_SetDeadTime(TIM8, dead_time);
  LL_TIM_CC_EnableChannel(
  TIM8,
                          LL_TIM_CHANNEL_CH1 | LL_TIM_CHANNEL_CH1N |
                          LL_TIM_CHANNEL_CH2 | LL_TIM_CHANNEL_CH2N |
  ...
  LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOC);
    ...
    PC8     ------> TIM8_CH3
    */
  GPIO_InitStruct.Pin = PWM_M2_AN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_3;
  LL_GPIO_Init(PWM_M2_AN_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = PWM_M2_BN_Pin|PWM_M2_CN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  GPIO_InitStruct.Pin = PWM_M2_A_Pin|PWM_M2_B_Pin|PWM_M2_C_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
void syncPwmTimers()
{
  //TIM8 slave start when TIM1 start.
